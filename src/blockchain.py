...
class Block:
    ...
    def __init__(self,diagnosis, doctor, index, transaction, timestamp, previous_hash, nonce = 0):
...
class Blockchain:
    ...
    def create_genesis_block(self):
        first_block = Block("flu", "Dr.Balls", 0, [], time.strftime('%X %x %Z'), "0") # I used time.strftime for an acurate date
    ...
    def mine(self, diagnosis, doctor):
